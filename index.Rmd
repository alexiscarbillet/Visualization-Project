...
```{r}
# Import des données
data <- read.table("https://raw.githubusercontent.com/alexiscarbillet/Visualization-Project/master/european-reserves-by-country-simplified.csv", header = TRUE, sep = ";")
