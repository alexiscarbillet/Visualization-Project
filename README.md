...
This repository gives the code of a [web application](https://alexiscarbillet.github.io/Visualization-Project/) to interactively explore our results. 
<br><br>

## How to use the application
The best way to use this application is by using [its online version](https://alexiscarbillet.github.io/Visualization-Project/)
<br><br>
You can also clone the whole repository to use this application locally.
